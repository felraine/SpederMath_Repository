    ...
    <div className="fixed inset-0 z-[9999]">
      ...
      >
        ...
        >
          ...
          {/* Body */}
          <div className="p-5">
            {/* Avatar + Name + Username + Summarize button */}
            <div className="flex items-center justify-between mb-6">
              ...
              {/* Summarize button (gradient style + filled sparkle) */}
              <button
                type="button"
                onClick={() => console.log("TODO: Summarize with AI")}
            ...
            {/* Details slot (progress, attempts, etc.) */}
            {hasAttempts ? (
              <div>{children}</div>
            ) : (
