...
function CreateStudentForm({ formData, handleInputChange, handleFileChange, handleFormSubmit, setShowForm }) {
  return (
      ...
      <div className="bg-white p-6 rounded-md w-96 relative z-10">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded-xl hover:bg-blue-800">Create Student</button>
          </div>
        </form>
      </div>
    </div>
