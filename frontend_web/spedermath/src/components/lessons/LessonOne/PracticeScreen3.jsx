...
const PracticeScreen3 = ({ onNext }) => {
  ...
  const startNewRound = () => {
    ...
    const q1 = new Audio("/audio/lesson1/how_many_balloons.mp3");
  ...
  const handleAnswer = (num) => {
    ...
    const playNextNumber = () => {
      if (i <= num) {
        const file =
          i === num
            ? `/audio/lesson1/${numberAudioMap[i]}_balloons.mp3`
